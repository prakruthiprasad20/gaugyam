  ...
  <h2 className="text-xl font-semibold text-white border border-brown-900 bg-amber-950 px-6 py-5 rounded-md">
    Explore GauGyam's Smart Features
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-17 px-8 py-16">
        ...
        <img src="/login.jpg" alt="Feature 1" className="rounded-lg shadow-lg w-full max-w-md" />
        ...
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/home.jpg" alt="Feature 2" className="rounded-lg shadow-lg w-full max-w-md" />
        ...
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/chat_assistant.jpg" alt="Feature 3" className="rounded-lg shadow-lg w-full max-w-md" />
          <p className="text-lg mt-4">Chat Assistant - Provides expert guidance on cow nutrition, feeding plans, and health management.</p>
        </div>

        {/* Row 2 */}
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/dashboard.jpg" alt="Feature 4" className="rounded-lg shadow-lg w-full max-w-md" />
        ...
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/cow_feeding_assistant2.jpg" alt="Feature 6" className="rounded-lg shadow-lg w-full max-w-md" />
        ...
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/cow_feeding_assistant.jpg" alt="Feature 5" className="rounded-lg shadow-lg w-full max-w-md" />
        ...
        {/* Row 3 */}
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/search.jpg" alt="Feature 7" className="rounded-lg shadow-lg w-full max-w-md" />
          <p className="text-lg mt-4">Search Page - Find doctors, pharmacies, hospitals, and cattle health topics in one place.</p>
        </div>

        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/schedule_appointment.png" alt="Feature 8" className="rounded-lg shadow-lg w-full max-w-md" />
        ...
        <div className="text-center border border-amber-950 p-5 rounded-lg shadow-lg">
          <img src="/view_appointments.jpg" alt="Feature 9" className="rounded-lg shadow-lg w-full max-w-md" />
